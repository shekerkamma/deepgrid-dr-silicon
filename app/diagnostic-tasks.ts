...
export const diagnosticTasks: UseCase[] = [
  ...
  {domain: 'motion', name: 'Duty-cycle and state tracking', detects: 'Start counts, dwell times, regime transitions', sensing: 'Existing peripherals', features: '—', model: 'HMM, 8 state', memory: '2 KB', latency: '0.06 ms', rate: '>1 kHz'},
  ...
  {domain: 'degradation', name: 'Remaining-useful-life regression', detects: 'Trend extrapolation over long feature history', sensing: '64 hourly feature snapshots', features: '—', model: 'MLP 128-64-32-8', memory: '10.5 KB', latency: '0.84 ms', rate: '970 Hz'},
  ...
  {domain: 'degradation', name: 'Short-horizon forecasting', detects: 'Predicts a slow process variable a few steps ahead', sensing: 'Any slow scalar, 64-step history', features: '—', model: 'GRU, 16 units', memory: '1.6 KB', latency: '2.95 ms', rate: '270 Hz'},
